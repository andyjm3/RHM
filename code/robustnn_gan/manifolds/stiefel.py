"""
Modified from geoopt and add ehess2rhess (without projection) for Stiefel with Euclidean metric
"""
...
class EuclideanStiefel(Stiefel):
    ...
    # added
    def ehess2rhesspreproj(self, x: torch.Tensor, egrad: torch.Tensor, ehess: torch.Tensor, u: torch.Tensor):
        """
        ehess: Eculidean Hessian along direction u
        """
        UsymXtG = u @ linalg.sym(x.transpose(-1, -2) @ egrad)
        return ehess - UsymXtG   
